// ======================================================================
// EClock.v generated from TopDesign.cysch
// 07/10/2024 at 01:05
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ccae75a3-bc05-4f35-af8f-d27a9a9ff698"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("29c0f251-9a63-4da2-a85c-540b3ed87a70"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3d3c4daf-353f-40c6-bee0-a2677287dd55"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8ff0fab9-a4ea-4bc5-b6c5-c50d66d48c61"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("eb9f192e-d2e9-46c8-8f5c-bd913822af84"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_1 TFT_BackLight (
        ...
        .tc(Net_304),
        .trigger(1'b0));
    defparam TFT_BackLight.Resolution = 8;


	cy_clock_v1_0
		#(.id("6ca7ccec-5bc6-45c9-bcd2-7485ad027da7"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000000"),
		  .is_direct(0),
    ...
    UART_v2_50_2 UART_LOG (
        ...
        .rx_clk(Net_265),
        .rx_data(Net_266),
        .rx_interrupt(Net_267),
        .tx(Net_268),
        .tx_clk(Net_269),
        .tx_data(Net_270),
        .tx_en(Net_271),
        .tx_interrupt(Net_272));
	...
	wire [0:0] tmpOE__Rx_UARTLOG_net;
	wire [0:0] tmpIO_0__Rx_UARTLOG_net;
	wire [0:0] tmpINTERRUPT_0__Rx_UARTLOG_net;
	electrical [0:0] tmpSIOVREF__Rx_UARTLOG_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		Rx_UARTLOG
		 (.oe(tmpOE__Rx_UARTLOG_net),
		  .y({1'b0}),
		  .fb({Net_264}),
		  .io({tmpIO_0__Rx_UARTLOG_net[0:0]}),
		  .siovref(tmpSIOVREF__Rx_UARTLOG_net),
		  .interrupt({tmpINTERRUPT_0__Rx_UARTLOG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Rx_UARTLOG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TX_DEBUGLOG_net;
	wire [0:0] tmpFB_0__TX_DEBUGLOG_net;
	wire [0:0] tmpIO_0__TX_DEBUGLOG_net;
	wire [0:0] tmpINTERRUPT_0__TX_DEBUGLOG_net;
	electrical [0:0] tmpSIOVREF__TX_DEBUGLOG_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		TX_DEBUGLOG
		 (.oe(tmpOE__TX_DEBUGLOG_net),
		  .y({Net_268}),
		  .fb({tmpFB_0__TX_DEBUGLOG_net[0:0]}),
		  .io({tmpIO_0__TX_DEBUGLOG_net[0:0]}),
		  .siovref(tmpSIOVREF__TX_DEBUGLOG_net),
		  .interrupt({tmpINTERRUPT_0__TX_DEBUGLOG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TX_DEBUGLOG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9b1b00ba-9678-4f08-b6d4-b43c4e6dfe64"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c305abde-0151-4eb9-a2a6-5e407b30f9e4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_1040 = Net_1039 | Net_1037;

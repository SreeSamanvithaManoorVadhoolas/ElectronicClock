...
/**
 *  file    SC_CONTROL_signal.h
 *
 *  brief   signal base class for signal sc_control
 *
...
#ifndef SC_CONTROL_SIGNAL_H_INCLUDED
#define SC_CONTROL_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_CONTROL_driverIn_t)(SC_CONTROL_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_CONTROL_driverOut_t)( const SC_CONTROL_data_t * const);
...
/**
 * Instances of the struct SC_CONTROL_cfg_t represent the signal object configuration.
 */
struct SC_CONTROL_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_CONTROL_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_CONTROL_driverOut_t const outDriver;
...
typedef const struct SC_CONTROL_cfg_s SC_CONTROL_cfg_t;
...
/**
 * Instances of the struct SC_CONTROL_t represent the signal objects.
...
{                                                                                                                      
     ...
     */
	const SC_CONTROL_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_CONTROL_s SC_CONTROL_t;
 ...
 *
 * @param  SC_CONTROL_t * const signal: Pointer to the signal object which will be initialised
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONTROL_init( SC_CONTROL_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_CONTROL_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_CONTROL_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_CONTROL_getStatus( const SC_CONTROL_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_CONTROL_setStatus( SC_CONTROL_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_CONTROL_getAge( const SC_CONTROL_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_CONTROL_incAge(  SC_CONTROL_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_CONTROL_t * const signal: Pointer to the signal object
 * @return sc_control_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_CONTROL_data_t* RTE_SC_CONTROL_getPtr( SC_CONTROL_t * const signal )
{               
 ...
 *
 * @param  SC_CONTROL_t * const signal: Pointer to the signal object
 * @return sc_control_data_t: current value of the application data buffer
 *
 **/
inline SC_CONTROL_data_t RTE_SC_CONTROL_get( const SC_CONTROL_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_CONTROL_t * const signal: Pointer to the signal object
 * @param  SC_CONTROL_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONTROL_getThreadSafe( const SC_CONTROL_t * const signal, SC_CONTROL_data_t * const data )
{    
 ...
 *
 * @param  SC_CONTROL_t * const signal: Pointer to the signal object
 * @param  sc_control_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_CONTROL_set(SC_CONTROL_t * const signal, const SC_CONTROL_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_CONTROL_pullPort( SC_CONTROL_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_CONTROL_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_CONTROL_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_CONTROL_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_CONTROL_pushPort( const SC_CONTROL_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
